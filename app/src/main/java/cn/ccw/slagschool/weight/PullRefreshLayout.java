...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.refresh_PullRefreshLayout_refreshType, STYLE_WATER_DROP);
        ...
        if (colorsId > 0) {
            ...
            mColorSchemeColors = new int[]{Color.rgb(0x00, 0xCA, 0xCA), Color.rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)};
        }
